...
public class OrderDetailId implements java.io.Serializable {
	...
	public OrderDetailId(Integer orderId, Integer gameId, int quantity, float subtotal) {
	...
	public boolean equals(Object other) {
		...
		return ((this.getOrderId() == castOther.getOrderId()) || (this.getOrderId() != null
				...
				&& ((this.getGameId() == castOther.getGameId()) || (this.getGameId() != null
						&& castOther.getGameId() != null && this.getGameId().equals(castOther.getGameId())))
