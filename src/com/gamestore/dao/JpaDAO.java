...
public class JpaDAO<E> {
	...
	static {
		entityManagerFactory= Persistence.createEntityManagerFactory("GameStoreWebsite");
	}
	...
	//for msost favored games we needed object as in query we were getting games,count,avg rev
